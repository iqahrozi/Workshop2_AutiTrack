...
class ParentRegistrationController {
  ...
  Future<void> updateProfile(BuildContext context, ParentModel parent) async {
    try {
      ...
      // Optionally, you can update the authentication display name
      User? currentUser = FirebaseAuth.instance.currentUser;
      if (currentUser != null) {
        await currentUser.updateProfile(displayName: parent.parentName);
      }
    } catch (error) {
      print('Error updating parent profile: $error');
